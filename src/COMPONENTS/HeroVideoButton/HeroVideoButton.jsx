...
const HeroVideoButton = () => {
  ...
  return (
    <div className="cs_hero_bottom_left1">
      <div className="cs_hero_btn_wrap">
        ...
        >
          ...
          <span className="cs_text_btn_text20">See how we work</span>
        </a>
      </div>
      ...
      {isOpen && (
        <div className="video_modal_overlay" onClick={closeModal}>
          <div
            className="video_modal_content slideUp"
          ...
          >
            ...
            width="100%"
            height="700"
            src="https://www.youtube.com/embed/VcaAVWtP48A"
            title="YouTube video"
            frameBorder="0"
