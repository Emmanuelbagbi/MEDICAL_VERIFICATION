...
import DoctorsSection from '../../COMPONENTS/DoctorsPageDoctorSecttion/DoctorsPageDoctorSecttion'
  ...
  return (
   <>
    ...
    <section
      ...
      data-src="https://prohealth-wp.laralink.com/wp-content/uploads/2023/10/banner_bg-3.svg"
      style={{
        backgroundImage:
          "url('https://prohealth-wp.laralink.com/wp-content/uploads/2023/10/banner_bg-3.svg')",
      }}
    >
      <div className="cs_banner_img">
        <img
          decoding="async"
          src="https://prohealth-wp.laralink.com/wp-content/uploads/2023/10/banner_img-2.png"
          alt=""
        />
      </div>
      ...
      <div className="Find-Doctors-container">
        <div className="cs_banner_text">
          <h2 className="cs_banner_title cs_fs_72gj">
            Introduce You to
            <br />
            Our Experts
          </h2>
    ...
    <div className='cs_height_xlwwa_150'></div>
    ...
    <div className="Backseat-container cs_footer_margin_0">
      <div
        ...
        data-src="https://prohealth-wp.laralink.com/wp-content/uploads/2023/10/banner_bg_2-1.jpeg"
        style={{
          backgroundImage:
            'url("https://prohealth-wp.laralink.com/wp-content/uploads/2023/10/banner_bg_2-1.jpeg")',
        }}
      >
